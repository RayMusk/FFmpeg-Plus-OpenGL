...
| ---- | ---- |
| 时间 | 2021/08/17 |
| - | 1.`plusglshader` Shader的 playTime uniform值纠正，当设置start参数时，playTime在start时刻以0开始 |
| 时间 | 2021/08/16 |
...
* 使用`lutglfilter`转码渲染 (Transcoding)
    ...
    * 参数项
        ...
        * `lut_source` : lut二维贴纸路径 (默认NULL)
            ...
            >   
            > 如图 512x512 <a href="Plus-GL-Shader/lut.jpg">./lut.jpg</a>
